...
class NgoFinanceInfoSchema(OrderedSchema):
    ...
    program_expense_ratio = fields.Float(allow_none=True)
    admin_expense_ratio = fields.Float(allow_none=True)
    ...
    donations_from_aboard = fields.Float()
    donations_from_israel = fields.Float()
    service_income_from_country = fields.Float()
    service_income_from_local_authority = fields.Float()
    service_income_from_other = fields.Float()
    other_income_from_other_sources = fields.Float()
    other_income_members_fee = fields.Float()
    expenses_other = fields.Float()
    expenses_for_management = fields.Float()
    ...
    expenses_for_activities = fields.Float()
